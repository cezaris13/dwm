...
#add your arandr layout script here
    ...
    then 
        ...
        feh --bg-scale $HOME/Pictures/wallpapers/alena-aenami-atlast2k2.jpg $HOME/Pictures/wallpapers/solar_system_horizontal.png 
    ...
    then 
        ...
        feh --bg-scale $HOME/Pictures/wallpapers/alena-aenami-atlast2k2.jpg $HOME/Pictures/wallpapers/solar_system_vertical.png 
    else
...
then
    ...
    feh --bg-scale $HOME/Pictures/wallpapers/alena-aenami-atlast2k2.jpg
fi