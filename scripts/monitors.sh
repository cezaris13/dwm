...
#add your arandr layout script here
    ...
    then 
	    xrandr --output eDP1 --primary --mode 1920x1080 --pos 1920x0 --rotate normal --output DP1 --mode 1920x1080 --pos 0x0 --rotate left --output HDMI1 --off --output HDMI2 --off --output VIRTUAL1 --off
    else
        xrandr --output eDP1 --primary --mode 1920x1080 --pos 1080x0 --rotate normal --output DP1 --mode 1920x1080 --pos 0x0 --rotate right --output HDMI1 --off --output HDMI2 --off --output VIRTUAL1 --off
    fi
elif [[ "$count" == "1" ]] 
then 
