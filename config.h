...
static Key keys[] = {
	...
	{ 0, XF86XK_AudioMute,					   spawn,		   SHCMD("$HOME/.config/dwm/scripts/dwm_specific/volume/./volume_control.sh toggleSound; kill -44 $(pidof dwmblocks)") },
	{ 0, XF86XK_AudioRaiseVolume,			   spawn,		   SHCMD("$HOME/.config/dwm/scripts/dwm_specific/volume/./volume_control.sh +3%;$HOME/.config/dwm/scripts/dwm_specific/volume/./volume_notification.sh") },
	{ 0, XF86XK_AudioLowerVolume,			   spawn,		   SHCMD("$HOME/.config/dwm/scripts/dwm_specific/volume/./volume_control.sh -3%;$HOME/.config/dwm/scripts/dwm_specific/volume/./volume_notification.sh") },
	{ 0, XF86XK_MonBrightnessUp,			   spawn,		   SHCMD("xbacklight -inc 10;$HOME/.config/dwm/scripts/dwm_specific/./brightness.sh") },
	{ 0, XF86XK_MonBrightnessDown,			   spawn,		   SHCMD("xbacklight -dec 10;$HOME/.config/dwm/scripts/dwm_specific/./brightness.sh") },
