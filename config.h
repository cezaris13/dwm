...
static const char *fonts[]          = {"monospace:pixelsize=13", "Hack Nerd Font Mono:pixelsize=14:antialias=true:autohint=true","fontawesome:size=12", "JoyPixels:pixelsize=10:antialias=true:autohint=true"};
